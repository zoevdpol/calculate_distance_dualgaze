...
class GUI:
    ...
    def _unopened_interface_drawer(self):
        ...
        print(">>> GUI geladen uit:", __file__)

        # Knop: nieuw leeg project
        imgui.set_cursor_pos((but_x, but_y))
        if imgui.button(ifa6.ICON_FA_FOLDER_PLUS+" New project 9", size=(but_width, but_height)):
        ...
        if imgui.button(ifa6.ICON_FA_FOLDER_OPEN+" Open project 5", size=(but_width, but_height)):
